...
The `thread_panel` HA custom integration lives at the repo root (`custom_components/thread_panel/`) rather than under `platform/` because HACS validates that path for repo compliance — see [`../docs/build_plan_v1.md`](../docs/build_plan_v1.md). V2 moves the integration into `platform/integration/thread_panel/` and switches HACS to `zip_release` artifact distribution; see [`../docs/build_plan_v2.md`](../docs/build_plan_v2.md).
